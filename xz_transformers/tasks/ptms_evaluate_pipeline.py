...
class EvaluatePipeline:
    ...
    def run(self, saved_path, batch_size=64):
        """
        ...
        for tmp_index, tmp_short_name in enumerate(self.ptm_short_names, 1):
            ...
            tmp_task_obj.evaluate_op(self.data_path, batch_size)
...
if __name__ == '__main__':
    ...
    evaluate_pipeline = EvaluatePipeline(tmp_ptm_short_names, tmp_num_labels, tmp_max_length, tmp_data_path,
                                         tmp_task_name)
    evaluate_pipeline.run(tmp_saved_path)

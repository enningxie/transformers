...
if __name__ == '__main__':
    ...
    tmp_model = TFBertForSequenceClassification(tmp_config).from_pretrained(model_name_or_path)

    # convert
    tmp_saved_path = model_name_or_path
    tmp_onnx_converter = ONNXConverterTF(tmp_tokenizer, hidden_size=768, num_heads=12)
    _, optimized_model_saved_path = tmp_onnx_converter.convert(tmp_model, tmp_saved_path, 'tf_model')
